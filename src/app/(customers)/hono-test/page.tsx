...
export default function HonoApiTestPage() {
  ...
  const testHealthEndpoint = async () => {
    ...
    try {
      ...
      setHelloMessage(
        `✅ Hono API Working! Status: ${data.status} - ${data.message}`
      );
    } catch (err) {
      setError(
        `Health Check Error: ${
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-gray-600 mb-8">
          Testing Next.js with Hono framework integration
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {helloMessage ? (
              ...
              <p className="text-gray-500">
                Click Test Health API to test basic connectivity
              </p>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {stats ? (
              ...
              <p className="text-gray-500">
                Click Test Stats API to load statistics
              </p>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {users.length > 0 ? (
              ...
              <p className="text-gray-500">
                Click Test Users API to load users data
              </p>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {products.length > 0 ? (
              ...
              <p className="text-gray-500">
                Click Test Products API to load products data
              </p>
            )}
          </div>
        </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold mb-3">
            Hono Integration Information
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <p>
                <strong>Frontend:</strong> Next.js with Hono
                (http://localhost:3000)
              </p>
              <p>
                <strong>Backend:</strong> Spring Boot (http://localhost:8080)
              </p>
              <p>
                <strong>API Framework:</strong> Hono.js for API routing
              </p>
            </div>
            <div>
              <p>
