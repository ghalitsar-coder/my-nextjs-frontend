                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      ...
                      {
                        todaysOrders.filter((o) => o.status === "PENDING")
                          .length
                      }{" "}
                            ...
                            <div className="flex flex-col space-y-2 ml-4">
                              ...
                              {order.status === "PENDING" && (
                                <Button
                                  ...
                                  onClick={() =>
                                    quickUpdateStatus(order.orderId, "PREPARED")
                                  }
                                >
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    ...
                    <Badge variant="secondary">
                      {
                        todaysOrders.filter((o) => o.status === "PREPARED")
                          .length
                      }
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    ...
                    <Badge variant="secondary">
                      {
                        todaysOrders.filter((o) => o.status === "DELIVERED")
                          .length
                      }
                    </Badge>
                  </div>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      (window.location.href =
                        "/dashboard/cashier/order-history")
                    }
                  >
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button
                onClick={() =>
                  selectedOrder &&
                  updateOrderStatus(selectedOrder.orderId, newOrderStatus)
                }
                disabled={
            ...
            <Card className="hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Process payments and manage transaction statuses
                </p>
                <Button
                  className="w-full"
                  onClick={() =>
                    (window.location.href = "/dashboard/cashier/payments")
                  }
                >
                  Manage Payments
                </Button>
              ...
              <CardContent className="p-6 text-center">
                <div className="mb-4 flex justify-center">
                  <div className="p-3 rounded-full bg-green-100 group-hover:bg-green-200 transition-colors">
                    <IconHistory className="h-8 w-8 text-green-600" />
                  </div>
                </div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  Order History
                ...
                <Button
                  className="w-full"
                  onClick={() =>
                    (window.location.href = "/dashboard/cashier/order-history")
                  }
                >
                  View History
                </Button>
              ...
              <CardContent className="p-6 text-center">
                <div className="mb-4 flex justify-center">
                  <div className="p-3 rounded-full bg-purple-100 group-hover:bg-purple-200 transition-colors">
                    <IconPrinter className="h-8 w-8 text-purple-600" />
                  </div>
                </div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  Print Reports
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Generate and print daily sales reports
                </p>
                <Button
                  className="w-full"
                  onClick={() => {
